...
public class State implements Serializable {
	...
	public State(HP hpFromNearbyEnemies, Units numberOfEnemiesUnitsNearby, HP hpFromNearbyAllies, Units numberOfAlliesUnitsNearby) {
	...
	public State(double hpFromNearbyEnemies, int numberOfEnemiesUnitsNearby, double hpFromNearbyAllies, int numberOfAlliesUnitsNearby) {
	...
	public State(RangeHP hpFromNearbyEnemies, RangeUnits numberOfEnemiesUnitsNearby, RangeHP hpFromNearbyAllies, RangeUnits numberOfAlliesUnitsNearby) {
		this.hpFromNearbyEnemies = new HP(hpFromNearbyEnemies);
		this.numberOfEnemiesUnitsNearby = new Units(numberOfEnemiesUnitsNearby);
		this.hpFromNearbyAllies = new HP(hpFromNearbyAllies);
		this.numberOfAlliesUnitsNearby = new Units(numberOfAlliesUnitsNearby);
